...
<form class="login100-form validate-form" action="/register" method="post" enctype="multipart/form-data">
	@csrf
...
<div class="wrap-input100 validate-input" data-validate="Upload an image">

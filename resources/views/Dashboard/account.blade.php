...
<label for="file"><img src="{{ $user->img }}" width="500" class="img" alt=""></label>
...
<input type="text" id="firstname" class="bg-light form-control" name="name" value="{{ $user->name }}">
</div>
<div class="col-md-6 pt-md-0 pt-3">
<label for="email">Email Address</label>
<input type="text" id="email" class="bg-light form-control" name="email" value="{{ $user->email }}">
</div>
</div>
<div class="row py-2">
  <div class="col-md-6">

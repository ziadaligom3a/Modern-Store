      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title d-inline-block">Edit Product: <?php echo e($product->getTranslation('name','en')); ?></h2>
              </div>
            </div>
            <div class="row tm-edit-product-row">
              ...
              <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                ...
                <p><img id="output" src="<?php echo e($product->img); ?>" width="200" />
                </p>
                <br>
                <br>
...
<?php /**PATH /var/www/html/Laravel-Projects/MAIN/resources/views/Admin/Dashboard/EditProduct.blade.php ENDPATH**/ ?>
      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="bn62 text-justify text-center" style="color:yellow">Add Product</h2>
...
<?php /**PATH /var/www/html/Laravel-Projects/MAIN/resources/views/Admin/Dashboard/AddProduct.blade.php ENDPATH**/ ?>
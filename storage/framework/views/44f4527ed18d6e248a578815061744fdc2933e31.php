      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="tm-block-title text-center">Edit Page: <?php echo e($page->name); ?></h2>
            ...
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <form action="/admin/home/pages/EditPage" method="post" class="tm-edit-product-form">
                  <?php echo csrf_field(); ?>
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input
                      id="name"
                      name="name_arabic"
                      value="<?php echo e($page->getTranslation('name','ar')); ?>"
                      type="text"
                      class="form-control validate"
                      required
                    />
              ...
              <div class="col-12">
                <button type="submit" class="btn btn-primary btn-block text-uppercase">Edit Page</button>
              </div>
            </form>
            </div>
          </div>
...
<?php /**PATH /var/www/html/Laravel-Projects/MAIN/resources/views/Admin/Dashboard/EditPage.blade.php ENDPATH**/ ?>
      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="bn62 text-justify text-center" style="color:yellow">Add Category</h2>
          ...
          <?php endif; ?>
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <form action="/admin/home/CategoryAdd/" method="post" enctype="multipart/form-data" class="tm-edit-product-form">
                  <?php echo csrf_field(); ?>
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input
                      id="name"
                      name="name_arabic"
                      value="<?php echo e(old('name_arabic')); ?>"
                      type="text"
                      class="form-control validate"
                      required
                    />
                  ...
                  <div>
                      <div class="form-group mb-3 col-xs-12 col-sm-15">
                          <label
                            for="expire_date"
                            >Slug
                          </label>
...
<?php /**PATH /var/www/html/Laravel-Projects/MAIN/resources/views/Admin/Dashboard/AddCategory.blade.php ENDPATH**/ ?>
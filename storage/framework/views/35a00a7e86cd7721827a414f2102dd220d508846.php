      ...
      <div class="row">
        <div class="col-xl-9 col-lg-10 col-md-12 col-sm-12 mx-auto">
          <div class="tm-bg-primary-dark tm-block tm-block-h-auto">
            <div class="row">
              <div class="col-12">
                <h2 class="bn62 text-justify text-center" style="color:yellow">Edit User: <?php echo e($user->name); ?></h2>
          ...
          <?php endif; ?>
            <div class="row tm-edit-product-row">
              <div class="col-xl-6 col-lg-6 col-md-12">
                <form action="/admin/home/Users/Edit" method="post" enctype="multipart/form-data" class="tm-edit-product-form">
                  <?php echo csrf_field(); ?>
                  ...
                  <div class="form-group mb-3">
                    ...
                    <option value="User"  <?php echo e($user->hasRole('User') ? 'selected' : ''); ?> >User</option>
              ...
              <div class="col-xl-6 col-lg-6 col-md-12 mx-auto mb-4">
                ...
                <p><img id="output" src="<?php echo e($user->img); ?>" width="200"  />
                </p>
                <br>
                <br>
              ...
              <div class="col-12">
                <button type="submit" class="btn btn-primary btn-block text-uppercase">Edit User</button>
              </div>
            </form>
            </div>
          </div>
...
<?php /**PATH /var/www/html/Laravel-Projects/MAIN/resources/views/Admin/Dashboard/EditUser.blade.php ENDPATH**/ ?>